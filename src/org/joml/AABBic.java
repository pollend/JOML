...
public interface AABBic {
     ...
     * @return dest
     */
    AABBi union(AABBi other, AABBi dest);
     ...
     * @return dest
     */
    AABBi intersection(AABBi other, AABBi dest);
     ...
     */
    boolean containsAABB(AABBd aabb);
     ...
     * @return <code>true</code> iff this AABB contains the AABB; <code>false</code> otherwise
     */
    boolean containsAABB(AABBf aabb);
     ...
     * @return <code>true</code> iff this AABB contains the AABB; <code>false</code> otherwise
     */
    boolean containsAABB(AABBi aabb);
     ...
     */
    boolean intersectsAABB(AABBi other);
     ...
     * @return <code>true</code> iff both AABBs intersect; <code>false</code> otherwise
     */
    boolean intersectsAABB(AABBf other);
